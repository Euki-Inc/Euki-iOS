...
class EUKLogViewController: EUKBasePinCheckViewController {
    ...
    var resetIncludeCycleSummary = true
    ...
    override func viewDidLoad() {
        ...
        self.resetIncludeCycleSummary = self.calendarItem?.includeCycleSummary ?? true
    }
...
extension EUKLogViewController: EUKBleedingViewDelegate {
	...
	func sizeChanged(size: BleedingSize?) {
		if size != nil , resetIncludeCycleSummary  {
            self.includeCycleSummary = true
            self.resetIncludeCycleSummary = false
		}
	}
}
