...
class CalendarManager: NSObject {
    ...
    func convert(eukCalendarItem: EUKCalendarItem) -> CalendarItem {
        ...
        if let contraceptionShot = ContraceptionShot(rawValue: Int(eukCalendarItem.contraceptionShotV2)) {
    ...
    func saveItem(calendarItem: CalendarItem, responseHandler: @escaping (Bool) -> Void) {
        ...
        eukCalendarItem.contraceptionShotV2 = Int16(calendarItem.contraceptionShot?.rawValue ?? -1)
